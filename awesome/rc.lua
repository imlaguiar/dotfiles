require("set") -- moved everythin related to awesome startup to set.lua in the same directory
local utils = require("utils")
local custom_widgets = require("widgets")
...
Naughty = require("naughty") -- made it globally available because it will be used across all configs
	...
	return wibox.widget({
		{
			...
			widget = wibox.container.margin,
                ...
                shape = utils.ui.rounded_rect(50),
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "r",
            function ()
              ...
              {description = "Spawn quick application launcher", group = "launcher"}),
    -- Quick file browser
    awful.key({ modkey },            ",",
            function ()
    ...
    awful.key({ modkey },            "b",
            function ()
                awesome.emit_signal("toggle_bluetooth_signal")
            end,
              {description = "Toggle bluetooth menu", group = "launcher"}),

    awful.key({}, "XF86AudioRaiseVolume" , function() utils.volume.increase() end, { description = "increase volume", group = "System configurations" }),

    awful.key({}, "XF86AudioLowerVolume" , function() utils.volume.decrease() end, { description = "Lower volume", group = "System configurations" }),
